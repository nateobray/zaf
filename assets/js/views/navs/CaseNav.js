...
export default class CaseNav extends Element
{
    ...
    async render()
    {
        ...
        this.regulatory = new Element('p', 'TThe ZAF AI provides legal information but is not a lawyer, does not create an attorney-client relationship, and is not a substitute for legal advice.', {class: 'regulatory-text'}).add(this.root)
